...
mixin _$ProductsController on ProductsControllerBase, Store {
  ...
  late final _$getProductsAsyncAction =
      AsyncAction('ProductsControllerBase.getProducts', context: context);

  @override
  Future<void> getProducts(String category) {
    return _$getProductsAsyncAction.run(() => super.getProducts(category));
  }
